...
class ProgressListener(gobject.GObject):
    ...
    def setup(self, webview):
        ...
        webview.web_progress.addProgressListener(self._wrapped_self, mask)
    ...
    def _get_location(self):
        '''Return a str with the current URI'''
        cls = components.classes['@mozilla.org/intl/texttosuburi;1']
        texttosuburi = cls.getService(components.interfaces.nsITextToSubURI)
        return texttosuburi.unEscapeURIForUI(uri.originCharset, self._location.spec)
